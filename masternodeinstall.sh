...
COIN_TGZ=`https://github.com/lapislazuli-project/lapislazuli/releases/download/lapislazuli-v1.0/lapislazuli-v1.0.0-x86_64-linux.tar`
COIN_ZIP=`https://github.com/lapislazuli-project/lapislazuli/releases/download/lapislazuli-v1.0/lapislazuli-v1.0.0-x86_64-linux.tar`
...
function download_node() {
  ...
  cd /usr/local/bin
  wget https://github.com/lapislazuli-project/lapislazuli/releases/download/lapislazuli-v1.0/lapislazuli-v1.0.0-x86_64-linux.tar
  tar -xvf lapislazuli-v1.0.0-x86_64-linux.tar
  cd lapislazuli-v1.0.0-x86_64-linux
